<%@page import="LapTrinhWeb_Cha.models.UserModel"%>
<%@page import="LapTrinhWeb_Cha.controllers.WaitingController"%>
...
<body>
	...
	<div class="form-group mt-3" align="center">
		<button type="button" class="btn btn-primary"
			onclick="window.location.href='${pageContext.request.contextPath}/profile'">Chỉnh
			sửa thông tin tài khoản</button>
	</div>
	<div class="wrapper">
		<!-- Sidebar -->
		<div class="sidebar" data-background-color="dark">
			...
			<div class="scroll-wrapper sidebar-wrapper scrollbar scrollbar-inner"
				...
				<div
					class="sidebar-wrapper scrollbar scrollbar-inner scroll-content"
					style="height: 738.4px; margin-bottom: 0px; margin-right: 0px; max-height: none;">
						...
						<ul class="nav nav-secondary">
							...
							<li class="nav-item"><a data-bs-toggle="collapse"
								...
								<div class="collapse" id="base">
									<ul class="nav nav-collapse">
										<li><a
											href="<c:url value = "/templates/components/avatars.html"/>">
												<span class="sub-item">Avatars</span>
										</a></li>
										<li><a
											href="<c:url value = "/templates/components/buttons.html"/>">
												<span class="sub-item">Buttons</span>
										</a></li>
										<li><a
											href="<c:url value = "/templates/components/gridsystem.html"/>">
												<span class="sub-item">Grid System</span>
										</a></li>
										<li><a
											href="<c:url value = "/templates/components/panels.html"/>">
												<span class="sub-item">Panels</span>
										</a></li>
										<li><a
											href="<c:url value = "/templates/components/notifications.html"/>">
												<span class="sub-item">Notifications</span>
										</a></li>
										<li><a
											href="<c:url value = "/templates/components/sweetalert.html"/>">
												<span class="sub-item">Sweet Alert</span>
										</a></li>
										<li><a
											href="<c:url value = "/templates/components/font-awesome-icons.html"/>">
												<span class="sub-item">Font Awesome Icons</span>
										</a></li>
										<li><a
											href="<c:url value = "/templates/components/simple-line-icons.html"/>">
												<span class="sub-item">Simple Line Icons</span>
										</a></li>
										<li><a
											href="<c:url value = "/templates/components/typography.html"/>">
							...
							<li class="nav-item"><a data-bs-toggle="collapse"
								...
								<div class="collapse" id="forms">
									<ul class="nav nav-collapse">
										<li><a
											href="<c:url value = "/templates/forms/forms.html"/>"> <span
												class="sub-item">Basic Form</span>
										</a></li>
									</ul>
								</div></li>
							<li class="nav-item"><a data-bs-toggle="collapse"
								...
								<div class="collapse" id="tables">
									<ul class="nav nav-collapse">
										...
										<li><a
											href="<c:url value = "/templates/tables/datatables.html"/>">
							...
							<li class="nav-item"><a data-bs-toggle="collapse"
								...
								<div class="collapse" id="maps">
									<ul class="nav nav-collapse">
										<li><a
											href="<c:url value = "/templates/maps/googlemaps.html"/>">
												<span class="sub-item">Google Maps</span>
										</a></li>
										<li><a
											href="<c:url value = "/templates/maps/jsvectormap.html"/>">
							...
							<li class="nav-item"><a data-bs-toggle="collapse"
								...
								<div class="collapse" id="charts">
									<ul class="nav nav-collapse">
										<li><a
											href="<c:url value = "/templates/charts/charts.html"/>">
												<span class="sub-item">Chart Js</span>
										</a></li>
										<li><a
											href="<c:url value = "/templates/charts/sparkline.html"/>">
							...
							<li class="nav-item"><a
								href="../../documentation/index.html"> <i
									class="fas fa-file"></i>
						...
						<ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
							...
							<li class="nav-item topbar-icon dropdown hidden-caret"><a
								...
								<ul class="dropdown-menu messages-notif-box animated fadeIn"
									...
									<li>
										<div
											class="scroll-wrapper message-notif-scroll scrollbar-outer"
											style="position: relative;">
											<div
												class="message-notif-scroll scrollbar-outer scroll-content"
												style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 0px;">
												<div class="notif-center">
													<a href="#">
														<div class="notif-img">
															<img
																src="<c:url value = "/templates/assets/img/jm_denis.jpg"/>"
																alt="Img Profile">
														</div>
														...
														<div class="notif-img">
															<img
																src="<c:url value = "/templates/assets/img/chadengle.jpg"/>"
																alt="Img Profile">
														</div>
														<div class="notif-content">
														...
														<div class="notif-img">
															<img
																src="<c:url value = "/templates/assets/img/mlane.jpg"/>"
																alt="Img Profile">
														</div>
														<div class="notif-content">
														...
														<div class="notif-img">
															<img
																src="<c:url value = "/templates/assets/img/talha.jpg"/>"
																alt="Img Profile">
														</div>
														<div class="notif-content">
											...
											<div class="notif-scroll scrollbar-outer scroll-content"
												...
												<div class="notif-center">
													<a href="#">
														...
														<div class="notif-img">
															<img
																src="<c:url value = "/templates/assets/img/profile2.jpg"/>"
																alt="Img Profile">
														</div>
														<div class="notif-content">
							...
							<li class="nav-item topbar-icon dropdown hidden-caret"><a
								...
								<div class="dropdown-menu quick-actions animated fadeIn">
									...
									<div
										class="scroll-wrapper quick-actions-scroll scrollbar-outer"
										style="position: relative;">
										<div
											class="quick-actions-scroll scrollbar-outer scroll-content"
											style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 0px;">
							...
							<li class="nav-item topbar-user dropdown hidden-caret submenu">
								...
								href="#" aria-expanded="false">
									<div class="avatar-sm">
										<img
											src="<c:url value = "/templates/assets/img/profile.jpg"/>"
								...
								<ul class="dropdown-menu dropdown-user animated fadeIn">
									<div
										...
										<div
											...
											style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 261.837px;">
											<li>
												<div class="user-box">
													<div class="avatar-lg">
														<img
											...
											<li>
												...
												class="dropdown-item" href="#">My Balance</a> <a
												class="dropdown-item" href="#">Inbox</a>
												<div class="dropdown-divider"></div> <a
												class="dropdown-item" href="#">Account Setting</a>
												<div class="dropdown-divider"></div> <a
							...
							<div class="card card-round">
								...
								<div class="card-body">
									<div class="chart-container" style="min-height: 375px">
										...
										<canvas id="statisticsChart" width="716" height="468"
											style="display: block; height: 375px; width: 573px;"
											class="chartjs-render-monitor"></canvas>
									</div>
									<div id="myChartLegend">
										<ul class="0-legend html-legend">
											<li><span style="background-color: #f3545d"></span>Subscribers</li>
											<li><span style="background-color: #fdaf4b"></span>New
												Visitors</li>
											<li><span style="background-color: #177dff"></span>Active
												Users</li>
										</ul>
									</div>
								</div>
							...
							<div class="card card-primary card-round">
								...
								<div class="card-body pb-0">
									...
									<div class="pull-in">
										...
										<canvas id="dailySalesChart" width="361" height="187"
											style="display: block; height: 150px; width: 289px;"
											class="chartjs-render-monitor"></canvas>
									</div>
								</div>
							</div>
							<div class="card card-round">
								<div class="card-body pb-0">
									...
									<div class="pull-in sparkline-fix">
										<div id="lineChart">
											<canvas width="378" height="70"
												style="display: inline-block; width: 378.725px; height: 70px; vertical-align: top;"></canvas>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="row">
													...
													<tbody>
														<tr>
															<td>
																<div class="flag">
																	<img
																		src="<c:url value = "/templates/assets/img/flags/id.png"/>"
																		alt="indonesia">
																</div>
															</td>
															<td>Indonesia</td>
														...
														<tr>
															<td>
																<div class="flag">
																	<img
																		src="<c:url value = "/templates/assets/img/flags/us.png"/>"
																		alt="united states">
																</div>
															</td>
															<td>USA</td>
														...
														<tr>
															<td>
																<div class="flag">
																	<img
																		src="<c:url value = "/templates/assets/img/flags/au.png"/>"
																		alt="australia">
																</div>
															</td>
															<td>Australia</td>
														...
														<tr>
															<td>
																<div class="flag">
																	<img
																		src="<c:url value = "/templates/assets/img/flags/ru.png"/>"
																		alt="russia">
																</div>
															</td>
															<td>Russia</td>
														...
														<tr>
															<td>
																<div class="flag">
																	<img
																		src="<c:url value = "/templates/assets/img/flags/cn.png"/>"
																		alt="china">
																</div>
															</td>
															<td>China</td>
														...
														<tr>
															<td>
																<div class="flag">
																	<img
																		src="<c:url value = "/templates/assets/img/flags/br.png"/>"
																		alt="brazil">
																</div>
															</td>
															<td>Brasil</td>
										...
										<div class="col-md-6">
											<div class="mapcontainer">
												<div id="world-map" class="w-100 jvm-container"
													style="height: 300px; background-color: transparent;">
													<svg width="561" height="300">
														<defs></defs>
														<g id="jvm-regions-group"
															transform="scale(0.6233333333333333) translate(0, 20.28855585788008)">
														<path
															...
															data-code="BD" fill="#dee2e8" fill-opacity="1"
														...
														<path
															...
															data-code="BE" fill="#dee2e8" fill-opacity="1"
															stroke="none" stroke-width="0" fill-rule="evenodd"
															class="jvm-region jvm-element"></path>
														<path
															...
															data-code="BF" fill="#dee2e8" fill-opacity="1"
															stroke="none" stroke-width="0" fill-rule="evenodd"
															class="jvm-region jvm-element"></path>
														<path
															...
															data-code="BG" fill="#dee2e8" fill-opacity="1"
															stroke="none" stroke-width="0" fill-rule="evenodd"
															class="jvm-region jvm-element"></path>
														<path
														...
														<path
															...
															data-code="BO" fill="#dee2e8" fill-opacity="1"
															stroke="none" stroke-width="0" fill-rule="evenodd"
															class="jvm-region jvm-element"></path>
														<path
															...
															data-code="JP" fill="#dee2e8" fill-opacity="1"
															stroke="none" stroke-width="0" fill-rule="evenodd"
															class="jvm-region jvm-element"></path>
														<path
															d="M495.45,295.49l-1.08,-2.99l1.14,-0.11l0.64,-1.19l0.76,0.09l0.65,1.83l-2.1,2.36Z"
															data-code="BI" fill="#dee2e8" fill-opacity="1"
															stroke="none" stroke-width="0" fill-rule="evenodd"
															class="jvm-region jvm-element"></path>
														<path
														...
														<path
															...
															data-code="BW" fill="#dee2e8" fill-opacity="1"
															stroke="none" stroke-width="0" fill-rule="evenodd"
															class="jvm-region jvm-element"></path>
														<path
															...
															data-code="BR" fill="#dee2e8" fill-opacity="1"
															stroke="none" stroke-width="0" fill-rule="evenodd"
														...
														<path
															...
															data-code="BS" fill="#dee2e8" fill-opacity="1"
															stroke="none" stroke-width="0" fill-rule="evenodd"
															class="jvm-region jvm-element"></path>
														<path
														...
														<path
															...
															data-code="RS" fill="#dee2e8" fill-opacity="1"
															stroke="none" stroke-width="0" fill-rule="evenodd"
															class="jvm-region jvm-element"></path>
														<path
															...
															data-code="LT" fill="#dee2e8" fill-opacity="1"
															stroke="none" stroke-width="0" fill-rule="evenodd"
															class="jvm-region jvm-element"></path>
														<path
															d="M436.08,149.45l-0.48,-0.07l0.3,-1.28l0.27,0.4l-0.09,0.96Z"
															data-code="LU" fill="#dee2e8" fill-opacity="1"
															stroke="none" stroke-width="0" fill-rule="evenodd"
															class="jvm-region jvm-element"></path>
														<path
														...
														<path
															...
															stroke="none" stroke-width="0" fill-rule="evenodd"
															class="jvm-region jvm-element"></path></g>
														<g id="jvm-regions-labels-group"></g>
														<g id="jvm-lines-group"></g>
														<g id="jvm-markers-group">
														<circle data-index="0" cx="428.91968837084164"
															cy="199.96558618496326" r="7" fill="#435ebe"
															fill-opacity="1" stroke="#FFF" stroke-width="5"
															stroke-opacity="0.5" class="jvm-marker jvm-element"></circle>
														<circle data-index="1" cx="141.9678944479907"
															cy="126.29810126460377" r="7" fill="#28ab55"
															fill-opacity="1" stroke="#FFF" stroke-width="5"
															stroke-opacity="0.5" class="jvm-marker jvm-element"
															cursor="pointer"></circle>
														<circle data-index="2" cx="319.8724698543684"
															cy="93.17387028162834" r="7" fill="#f3616d"
															fill-opacity="1" stroke="#FFF" stroke-width="5"
															stroke-opacity="0.5" class="jvm-marker jvm-element"></circle>
														<circle data-index="3" cx="443.6350717559091"
															cy="124.38464843674497" r="7" fill="#374151"
															fill-opacity="1" stroke="#FFF" stroke-width="5"
															stroke-opacity="0.5" class="jvm-marker jvm-element"></circle>
														<circle data-index="4" cx="262.0169924490049"
															cy="101.8032115368878" r="7" fill="#374151"
															fill-opacity="1" stroke="#FFF" stroke-width="5"
															stroke-opacity="0.5" class="jvm-marker jvm-element"></circle>
														<circle data-index="5" cx="380.47274131979754"
															cy="147.24442340454803" r="7" fill="#374151"
															fill-opacity="1" stroke="#FFF" stroke-width="5"
															stroke-opacity="0.5" class="jvm-marker jvm-element"></circle>
														<circle data-index="6" cx="495.1546782757112"
															cy="247.67099006692104" r="7" fill="#374151"
															fill-opacity="1" stroke="#FFF" stroke-width="5"
															stroke-opacity="0.5" class="jvm-marker jvm-element"></circle>
														<circle data-index="7" cx="194.3632023491413"
															cy="226.6212036267043" r="7" fill="#374151"
															fill-opacity="1" stroke="#FFF" stroke-width="5"
															stroke-opacity="0.5" class="jvm-marker jvm-element"></circle>
														<circle data-index="8" cx="303.57296473171124"
															cy="147.32860832651778" r="7" fill="#374151"
															fill-opacity="1" stroke="#FFF" stroke-width="5"
															stroke-opacity="0.5" class="jvm-marker jvm-element"></circle></g>
														<g id="jvm-markers-labels-group"></g></svg>
	...
	<!--   Core JS Files   -->
	<script
		src="<c:url value = "/templates/assets/js/core/jquery-3.7.1.min.js"/>"></script>
	<script
		src="<c:url value = "/templates/assets/js/core/popper.min.js"/>"></script>
	<script
		src="<c:url value = "/templates/assets/js/core/bootstrap.min.js"/>"></script>

	<!-- jQuery Scrollbar -->
	<script
		src="<c:url value = "/templates/assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js"/>"></script>

	<!-- Chart JS -->
	<script
		src="<c:url value = "/templates/assets/js/plugin/chart.js/chart.min.js"/>"></script>

	<!-- jQuery Sparkline -->
	<script
		src="<c:url value = "/templates/assets/js/plugin/jquery.sparkline/jquery.sparkline.min.js"/>"></script>

	<!-- Chart Circle -->
	<script
		src="<c:url value = "/templates/assets/js/plugin/chart-circle/circles.min.js"/>"></script>

	<!-- Datatables -->
	<script
		src="<c:url value = "/templates/assets/js/plugin/datatables/datatables.min.js"/>"></script>

	<!-- Bootstrap Notify -->
	<script
		src="<c:url value = "/templates/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js"/>"></script>

	<!-- jQuery Vector Maps -->
	<script
		src="<c:url value = "/templates/assets/js/plugin/jsvectormap/jsvectormap.min.js"/>"></script>
	<script
		src="<c:url value = "/templates/assets/js/plugin/jsvectormap/world.js"/>"></script>

	<!-- Sweet Alert -->
	<script
		src="<c:url value = "/templates/assets/js/plugin/sweetalert/sweetalert.min.js"/>"></script>

	<!-- Kaiadmin JS -->
	<script src="<c:url value = "/templates/assets/js/kaiadmin.min.js"/>"></script>

	<!-- Kaiadmin DEMO methods, don't include it in your project! -->
	<script src="<c:url value = "/templates/assets/js/setting-demo.js"/>"></script>
	<script src="<c:url value = "/templates/assets/js/demo.js"/>"></script>
	<script>
	...
	<div class="jvm-tooltip"
		style="background-color: rgb(67, 94, 190); top: 1196.51px; left: 628.825px;">Brazil</div>
	<div
