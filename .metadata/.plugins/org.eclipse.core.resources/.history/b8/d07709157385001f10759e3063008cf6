...
<%
// Giả sử bạn đã lưu đối tượng user trong session khi người dùng đăng nhập
	...
	<div
		...
		<div
			...
			<div class="navbar align-self-center d-flex">
				...
				<div class="dropdown">
					<button
						class="btn btn-secondary dropdown-toggle nav-icon position-relative text-decoration-none"
